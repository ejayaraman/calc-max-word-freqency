...
class LineAnalyzer
  ...
  def calculate_word_frequency
    ...
    content_array.each do |word|
      if content_array.count(word) >= @highest_wf_count 
        @highest_wf_words.clear if content_array.count(word) > @highest_wf_count 
        @highest_wf_words |= [word]
        @highest_wf_count = content_array.count(word) 
      end
    end 
  end
end
...
class Solution
  ...
  def calculate_line_with_highest_frequency
   ...
   @highest_count_words_across_lines = @analyzers.select{|analyzer| analyzer.highest_wf_words if analyzer.highest_wf_count == @highest_count_across_lines}
